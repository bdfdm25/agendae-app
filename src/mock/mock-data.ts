...
export const SCHEDULES: ISchedule[] = [
  {
    ...
    hour: new Date().getHours().toLocaleString() + ":00",
    status: "",
  },
  {
    id: new Date().toString() + Math.random().toString(),
    ...
    date: new Date().toISOString().split("T")[0],
    hour: (new Date().getHours() + 1).toLocaleString() + ":00",
    status: "",
  },
  {
    id: new Date().toString() + Math.random().toString(),
    ...
    date: new Date().toISOString().split("T")[0],
    hour: (new Date().getHours() + 2).toLocaleString() + ":00",
    status: "",
  },
  {
    id: new Date().toString() + Math.random().toString(),
    ...
    date: new Date().toISOString().split("T")[0],
    hour: (new Date().getHours() + 3).toLocaleString() + ":00",
    status: "",
  },
  {
    id: new Date().toString() + Math.random().toString(),
    ...
    date: new Date().toISOString().split("T")[0],
    hour: (new Date().getHours() + 4).toLocaleString() + ":00",
    status: "",
  },
  {
    id: new Date().toString() + Math.random().toString(),
    ...
    date: new Date().toISOString().split("T")[0],
    hour: (new Date().getHours() + 5).toLocaleString() + ":00",
    status: "",
  },
  {
    id: new Date().toString() + Math.random().toString(),
    ...
    date: new Date().toISOString().split("T")[0],
    hour: (new Date().getHours() + 6).toLocaleString() + ":00",
    status: "",
  },
  {
    id: new Date().toString() + Math.random().toString(),
    ...
    date: new Date().toISOString().split("T")[0],
    hour: (new Date().getHours() + 7).toLocaleString() + ":00",
    status: "",
  },
  {
    id: new Date().toString() + Math.random().toString(),
    ...
    date: new Date().toISOString().split("T")[0],
    hour: (new Date().getHours() + 8).toLocaleString() + ":00",
    status: "",
  },
  {
    id: new Date().toString() + Math.random().toString(),
    ...
    date: new Date().toISOString().split("T")[0],
    hour: (new Date().getHours() + 9).toLocaleString() + ":00",
    status: "",
  },
];
