...
export function SignupView({ signinHandler, signupHandler, loading }) {
  ...
  const signup = (
    <PrimaryButton onPress={handleSubmit(signupHandler)}>
      cadastrar
    </PrimaryButton>
  );
              ...
              render={({ field: { onChange, value } }) => (
                <TextInput
                  ...
                  placeholderTextColor={
                    GlobalStyles.colors.inputPlaceholderColor
                  }
                  onChangeText={onChange}
                  value={value}
                />
            ...
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <Switch
                  ...
                  thumbColor={
                    isSpEnabled
                      ? GlobalStyles.colors.switchThumbEnable
                      : GlobalStyles.colors.switchThumbDisable
                  }
