    ...
    return (
        <View style={[GlobalStyles.rootContainer]}>
            ...
            <View style={styles.successContainer}>
                <Ionicons name="checkmark-circle-outline" size={120} color={GlobalStyles.colors.primary400} />
                <Title color={GlobalStyles.colors.primary400}>Tudo certo!</Title>
                <Subtitle>Dados enviados via e-mail. Confira também sua caixa de spam.</Subtitle>
            </View>
        </View>
    );
}
